...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        <p class="text-left addtea pull-left">当前位置 <i class="layui-icon" style="font-size: 15px;">&#xe602;</i> 首页
            <i class="layui-icon" style="font-size: 15px;">&#xe602;</i> 添加教师用户</p>
    </div>
</nav>
<!--          内容区-->
<div class="container">
        ...
        <div class="col-md-6 forms">
            <form class="layui-form">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" id="tPwd" name="tPwd" lay-verify="required|pwd" autocomplete="off" placeholder="密码必须是6-16位字母加数字组合"
                               class="layui-input">
                    </div>
                </div>
                <!--                性别-->
