...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        <p class="text-left addtea pull-left">当前位置 <i class="layui-icon" style="font-size: 15px;">&#xe602;</i> 首页
            <i class="layui-icon" style="font-size: 15px;">&#xe602;</i> 管理学院</p>
    </div>
</nav>
<!--          内容区-->
<div class="container">
...
<%--        </div>--%>
        <div class="col-md-3">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="title" id="name" required="" lay-verify="" placeholder="请输入学院名称"
                           autocomplete="off" class="layui-input ">
                    <input type="hidden" id="cid" name="cid" autocomplete="off" class="layui-input ">
                </div>
            </div>
        </div>
        <div class="col-md-3">
