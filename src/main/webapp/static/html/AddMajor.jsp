        ...
        <div class="col-md-6 forms">
            <form class="layui-form" method="post">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" id="mname" name="mname" lay-verify="" autocomplete="off"
                               class="layui-input">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <select id="mstatus" name="mstatus" lay-verify="required" lay-filter="test">
                            <option value="">--请选择--</option>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" id="mremark" name="mremark" lay-verify="" autocomplete="off"
                               class="layui-input">
                    </div>
                </div>
                <!--                提交按钮-->
