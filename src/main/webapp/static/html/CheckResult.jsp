...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/js/ResultCheckManager.js"></script>
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="demoTable" style="margin-top: 20px">
            ...
            <div style="width: 100%">
                <div id="pie_eCharts" style="width: 400px;height:400px;float: left;margin-left: 20px"></div>
